...
def turtle4():
    danny = rg.SimpleTurtle('turtle')
    danny.pen = rg.Pen('red', 6)

    danny.forward(-150)

    danny.begin_fill()
    danny.draw_circle(150)
    danny.end_fill()


def turtle5():
    ed = rg.SimpleTurtle('turtle')
    ed.pen = rg.Pen('purple', 10)
    ...
    ryan = rg.SimpleTurtle('square')
    ryan.pen = rg.Pen('blue',15)
    ryan.paint_bucket = rg.PaintBucket('green')

    ryan.backward(250)

    ryan.begin_fill()
    ryan.draw_regular_polygon(5,200)
